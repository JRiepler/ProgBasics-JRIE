...
public class ProgBasics : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        AddNumbers(3, 2);
        MultNumbers(2, 3, 1, 2);
        MyDatas("18", "Student", "183cm");
        SubNumbers(321, 123);
        meinName("Jonas", "Riepler");
        // all methodes combined
        Combine();
        //return type
        Debug.Log(MyText("jriepler"));
        string drama = MyText("jriepler");
        Debug.Log("neu " + drama);
        Debug.Log(Wohnort("Bischofshofen"));
        Debug.Log(yo("Lil", "Lano"));
    }
    //Methode deklaiert
    public void XY()
    {
